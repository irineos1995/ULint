...
class Relations:
    ...
    def create_documentation(self, filename="documentation.html"):
        ...
        fine_relations = self.construct_fine_relations()
        self.dump_rules('static_documentation_rules/rules.json')
        table_string = ''
